// 导入全局配置
const globalConfig = require('./Bmob-config-extracted.js');
const API_HOST = globalConfig.BmobConfig.host;
...
! function(e, t) {
    ...
    return function(e) {
        ...
        e.exports = {
            host: typeof API_HOST !== 'undefined' ? API_HOST : "http://localhost:8080",
            applicationId: "",
            applicationKey: "",
